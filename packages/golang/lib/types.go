...
//go:generate go run github.com/abice/go-enum@latest -f=$GOFILE --marshal --lower
...
// Kind of relation
// ENUM(beaconOf, evmOf, other, forkedFrom, l2Of, shardOf, testnetOf)
type RelationKind string

const (
	BeaconOf    = RelationKindBeaconOf
	EvmOf       = RelationKindEvmOf
	FluffyOther = RelationKindOther
